...
<template>
    <UContainer class="py-12">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-3 gap-4 mb-8 p-6 bg-accented rounded-lg">
                <div v-if="recipe.prepTime">
                    <div class="text-sm text-inverted">Prep Time</div>
                    <div class="text-lg text-inverted font-semibold">
                        {{ recipe.prepTime }} min
                    </div>
                </div>
                <div v-if="recipe.cookTime">
                    <div class="text-sm text-inverted">Cook Time</div>
                    <div class="text-lg text-inverted font-semibold">
                        {{ recipe.cookTime }} min
                    </div>
                </div>
                <div v-if="recipe.servings">
                    <div class="text-sm text-inverted">Servings</div>
                    <div class="text-lg text-inverted font-semibold">
                        {{ recipe.servings }}
                    </div>
                </div>
